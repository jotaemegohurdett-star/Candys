        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="aspect-[3/4] rounded-3xl overflow-hidden">
              <img src={colabImg} alt="Colaboración Candy's Pet x Club Chihuahua Chile" className="w-full h-full object-cover object-top" />
            </div>
            <div className="aspect-[3/4] rounded-3xl overflow-hidden mt-8">
              <img src={poodleImg} alt="Colaboración Candy's Pet x Club Poodle Chile" className="w-full h-full object-cover object-top" />
            </div>
          </motion.div>
