  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Repetir escena: activo' : 'Repetir escena: inactivo'}
        aria-label={locked ? 'Repetir escena: activo' : 'Repetir escena: inactivo'}
        aria-pressed={locked}
      >
...
export default function VideoWithControls() {
  ...
  // Export path: no props, preserves recording markers, no control bar
